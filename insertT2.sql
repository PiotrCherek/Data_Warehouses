...
FROM 'C:\Users\Piotrek\Documents\GitHub\Data_Warehouses\customers_T2.bulk'
WITH (
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '0x0a'
);
...
FROM 'C:\Users\Piotrek\Documents\GitHub\Data_Warehouses\owned_board_games_T2.bulk'
WITH (
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '0x0a'
);
...
FROM 'C:\Users\Piotrek\Documents\GitHub\Data_Warehouses\tournaments_T2.bulk'
WITH (
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '0x0a'
);
...
FROM 'C:\Users\Piotrek\Documents\GitHub\Data_Warehouses\tournament_participants_T2.bulk'
WITH (
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '0x0a'
);
...
FROM 'C:\Users\Piotrek\Documents\GitHub\Data_Warehouses\posters_T2.bulk'
WITH (
    FIELDTERMINATOR = '|',
    ROWTERMINATOR = '0x0a'
);
